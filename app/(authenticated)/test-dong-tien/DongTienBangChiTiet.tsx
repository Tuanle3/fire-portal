...
import { KhoanDongTien, NHOM_LABEL, DO_TIN_CAY_LABEL } from '@/lib/dong-tien-types'
    ...
    <div>
      ...
      <table className="nh-tbl">
        ...
        <tbody>
          ...
          {sorted.length === 0 && (
            <tr>
              <td colSpan={7} style={{ textAlign: 'center', color: 'var(--nh-muted2)', padding: 24 }}>Chưa có khoản nào khớp bộ lọc.</td>
            </tr>
          )}
        </tbody>
      </table>
